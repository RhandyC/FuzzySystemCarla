...
class VehiclePIDController():
    ...
    def run_step(self, target_speed, waypoint, offset): ############## Change
        """
        ...
        current_steering = self._lat_controller.run_step(waypoint,offset)
...
class PIDLateralController():
    ...
    def run_step(self, waypoint, offset): ######## Change
        """
