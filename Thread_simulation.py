...
class ThreadSimulation (threading.Thread):
    ...
    def update_TIV(self):
        while True:
            ...
            self.calculator._frontalRightSpeed = realSpeedFrontRightVehicle
            self.calculator._frontalLeftSpeed = realSpeedFrontLeftVehicle
            self.calculator._rearRightSpeed = realSpeedRearRightVehicle
            self.calculator._rearLeftSpeed = realSpeedRearLeftVehicle
